...
#Протестируем функцию на файле «article.txt» со следующим содержимы
...
#         writer.writerow([x, hours, minutes, second, microsec])
#         sleep(0.1)
...
#     # result = [x if x =='*' else y for x, y in zip(text_lower, text)] #-> 1 вариант
#     result = [(y, x)[x=='*'] for x, y in zip(text_lower, text)]  #-> 2 вариант
#     print(''.join(result))
