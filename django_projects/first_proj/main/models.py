...
class Award(models.Model):
    owner = models.OneToOneField(Musicion, on_delete=models.CASCADE,
...
class Song(models.Model):
    ...
    author = models.ForeignKey(Musicion, on_delete=models.CASCADE,
                               related_name='songs')
    feat = models.ForeignKey(Musicion, on_delete=models.SET_NULL, null=True,
