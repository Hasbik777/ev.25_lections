# from views import CreatMixin, RetrieveMixin, UpdateMixin, DestroyMixin

# class Product(CreatMixin, RetrieveMixin, UpdateMixin, DestroyMixin):
#     def save(self):
#         import json
...
#         return {'price': sum(prices), 'final_prices': total_price}

#     def _substract_qty(self, item, product):
#         result = product['qty'] - item['qty']
#         if result < 0:
#             raise ValueError('Too many qty of product!')
#         product['qty'] = result
...
# print(smartphones.post(title='Samsung S22 Ultra', description='Flagman of Poco phones!', qty=5, price=400))
# print()
...
# print('Orders: ')
# products_for_order = [{'id': 3, 'qty': 2}, {'id': 4, 'qty': 2}]
# print(orders.creat_order(products_for_order))
# print('After Order: -----------------')
# print(smartphones.detail(3))
# print(smartphones.detail(4))
# print()
# print()
# products_for_order = [{'id': 1, 'qty': 5}]
# print(orders.creat_order(products_for_order))
# products_for_order = [{'id': 4, 'qty': 1}, {'id': 2, 'qty': 3}, {'id': 3, 'qty': 7}]
# print(orders.creat_order(products_for_order))
