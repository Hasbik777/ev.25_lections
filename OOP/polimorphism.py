...
# + (add_)- метод порлиморфизм
# print(5+5)
# print('hello'+'word')
# print([1,23,4]+[4,5,6])

# # полиморфизм спосоьность фунции искользоваться для разынх типов классов 
# широко распрастроненноге опрделение для полиморфизма 'один интерфейс много реализайций'
...
#     def info(self):
#         print(f'It is a dog. Dogs name is {self.name}, age: {self.age}')
...
#     def fact(self):
#         return 'У квадрата все стороны равны и углы равны 90 градусов'
...
#             raise Exception('Нельзя прослушать музыку, телефон разряжен!')
#         print('Слушает Мирбека Атабекова')
...
# phone = Phone('123 123123 123', 'IOS 15')
# phone.battery_level
# phone.battery_level
# phone.get_info
# phone.battery_level
